    ...
    <div class="ratings-content">
      <div class="overview">
        <div class="overview-left">
          <h1 class="score"></h1>
          <div class="title">综合评分 {{info.score}}</div>
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on: onlyShowText}" @click="toggleTextShow">
          <span class="iconfont icon-duigouxuanzhong"></span>
...
export default {
  data () {
    return {
      onlyShowText: true, //  是否只显示有文本内容
      selectType: 2 //  0 满意 1 不满意 2全部
    }
  },
   mounted () {
  ...
  computed: {
    ...
    filterRatings () {
      ...
      return ratings.filter(rating => {
        // rateType：评价类型 text 评价内容
        const {rateType, text} = rating
        /** 条件一: 选择的类型
         *  selectType: 0/1/2
         *  rateType: 0/1
         *  因此选择的类型 selectType === 2 || selectType === rateType
         *  条件二: 是否显示有内容的评价
         *  onlyShowText: true/false
         *  text:有值/没值 (text.length)
         *  因此!onlyShowText(看所有的) || text.length > 0(只看有值的)
         * 
         */
